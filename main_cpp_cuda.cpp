...
int main() {
    SetDllDirectory(L"Q:\\xlxlqqq\\EngApps\\anacondaEnvs\\pointnet\\Lib\\site-packages\\torch\\lib");
    try {
        ...
        const wchar_t* model_path = L"./model/model_FP16.onnx";
        //const wchar_t* model_path = L"./model/model_FP16.onnx";
